    ...
    <section className='bg-white'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6'>
        <div className='mx-auto max-w-screen-sm text-center lg:mb-16 mb-8'>
          <h2 className='mb-4 text-4xl text-gray-900 sm:text-5xl font-bebas tracking-wider'>Latest Updates</h2>
          <p className='font-light text-gray-500 sm:text-xl'>Catch up on our latest news and insights.</p>
        </div>
        <div className='grid gap-8 lg:grid-cols-2'>
          <article className='p-6 bg-white border border-gray-200 shadow-lg'>
